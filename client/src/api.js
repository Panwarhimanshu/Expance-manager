...
export const api = {
  ...
  updateExpense: (id, data) => req(`/expenses/${id}`, { method: "PUT", body: JSON.stringify(data) }),
  ...
  updateSale: (id, data) => req(`/sales/${id}`, { method: "PUT", body: JSON.stringify(data) }),
  deleteSale: (id) => req(`/sales/${id}`, { method: "DELETE" }),
  restoreSale: (data) => req("/sales/restore", { method: "POST", body: JSON.stringify(data) }),
  addSettlement: (data) => req("/settlements", { method: "POST", body: JSON.stringify(data) }),
  deleteSettlement: (id) => req(`/settlements/${id}`, { method: "DELETE" }),
  restoreSettlement: (data) => req("/settlements/restore", { method: "POST", body: JSON.stringify(data) }),
